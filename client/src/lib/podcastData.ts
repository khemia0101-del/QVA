...
export const podcastEpisodes: PodcastEpisode[] = [
  {
    ...
    audioUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663031027310/qpgjOOtXhzufojBC.wav",
    ...
    timestamps: [
      ...
      { time: "2:30", label: "What is a credit partnership? The concept explained simply" },
      { time: "6:15", label: "The five-step process from application to payout" },
      { time: "10:45", label: "Real deal example — How a 760 score generated a $18,000 payout" },
      { time: "14:20", label: "Non-recourse protection — Why your assets are safe" },
      { time: "17:00", label: "Who qualifies and who doesn't" },
      { time: "19:30", label: "Common myths debunked" },
  ...
  },
  {
    ...
    audioUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663031027310/LMgRYkaosXZtUJIY.wav",
    ...
    timestamps: [
      ...
      { time: "1:45", label: "What DSCR stands for and the simple math behind it" },
      { time: "5:00", label: "DSCR vs. traditional mortgages — side by side comparison" },
      { time: "8:30", label: "Why DSCR lenders don't care about your W-2" },
      { time: "11:00", label: "The credit score factor — how your score sets the rate" },
      { time: "14:15", label: "Non-recourse explained in the context of DSCR" },
      { time: "16:30", label: "Why this creates the credit partnership opportunity" },
      { time: "18:00", label: "How to take advantage — next steps" },
    ],
    transcript: [
  ...
  },
  {
    ...
    audioUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663031027310/vuQenYLsCBfXoNxf.wav",
    ...
    timestamps: [
      ...
      { time: "2:00", label: "Strategy 1: Credit card rewards optimization" },
      { time: "5:30", label: "Strategy 2: Balance transfer arbitrage" },
      { time: "9:00", label: "Strategy 3: Authorized user income" },
      { time: "12:30", label: "Strategy 4: Business credit leveraging" },
      { time: "16:00", label: "Strategy 5: Real estate credit partnerships" },
      { time: "20:00", label: "Comparing all five strategies — which pays the most?" },
      { time: "23:00", label: "How to get started with credit partnerships" },
    ],
    transcript: [
      `Welcome to episode 3 of The Credit Partnership Playbook. Today we're going to talk about something that I think is really important — the idea that your credit score is an asset, not just a number.`,
